...
app, login_frame, username_textbox, status_dropdown, error_label = create_login_page()

# Create the login button
login_button(login_frame, username_textbox, status_dropdown, app, user_friend_list, user_game_list, achievement_score, error_label)
